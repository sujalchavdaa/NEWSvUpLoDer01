        ...
        for i in range(arg-1, len(links)):
            ...
            try:
                ...
                cczip = (
                    ...
                    f"**╰━━━━━━━━━━━╯**\n\n"
                    f"🗂️ <b>Tɪᴛʟᴇ: {name1} 𓍯𝙎𝙪𝙟𝙖𝙡⚝.zip</b>\n\n"
                    f">💎 <b>𝐂ⱺᴜʀꜱᴇ:</b> {b_name}\n\n"
                    f">𖣐 <b>𝗫𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆:</b> {CR}"
